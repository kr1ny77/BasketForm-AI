...
This file is the authoritative current registry of stable user-story IDs and current user-story membership.

| ID | Short title | MoSCoW priority | Issue | Requirement status | Work Status | Sprint |
|---|---|---|---|---|---|---|
| US-001 | Upload shooting form video | Must Have | [#20](https://github.com/kr1ny77/BasketForm-AI/issues/20) | Active | Done | [Sprint 1](https://github.com/kr1ny77/BasketForm-AI/milestone/1) |
| US-002 | View automated form analysis | Must Have | [#21](https://github.com/kr1ny77/BasketForm-AI/issues/21) | Active | Done | [Sprint 1](https://github.com/kr1ny77/BasketForm-AI/milestone/1) |
